...
function updatePlanBadge(plan) {
    ...
    badge.className = `hidden md:inline-block text-[15px] px-2 py-0.5 rounded border font-mono font-bold ${isPremium ? "text-black-400 border-black-500/20 bg-black-500/10" : "text-black-400 border-black-500/20 bg-red-500/10 animate-pulse"}`;
