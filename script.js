...
const LINK_DATA = {
    ...
    software: [
        { name: "Camtasia 2024 (Pre-Activated)", url: "#" },
        { name: "Adobe Photoshop 2025", url: "#" },
        { name: "Wondershare Filmora 13", url: "#" }
    ]
};

// 🔥 VIDEO LINKS
const COURSE_VIDEOS = [
    { title: "Class 01: CPA Self SignUp সেরা CPA সাইট ও একাউন্ট খোলার নিয়ম!", url: "https://drive.google.com/file/d/1v2uwF2J4oSKgh64uLcle1Wn-BgLQnBCL/view?usp=sharing" },
...
// SECURITY: BLOCK RIGHT CLICK & INSPECT
