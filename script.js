...
function checkLoginStatus() {
    ...
    if (user && user.isLoggedIn) {
        ...
        document.getElementById('noticeText').innerText = "Website এর সমস্ত আপডেটের কাজ চলমান রয়েছে.সকল ভিডিও, টুলস, সফটওয়্যার নতুন করে আপডেট করা হচ্ছে ! খুব দ্রুত আপনাদের নতুন আপডেট দেয়া হবে ! তাই সাময়িকভাবে কিছু অসুবিধা হতে পারে এর জন্য আমরা আন্তরিকভাবে দুঃখিত.যেকোনো পরিস্থিতিতে আপনারা কাজ চালিয়ে যান ! জরুরী প্রয়োজনে অবশ্যই সাপোর্টে যোগাযোগ করবেন";
