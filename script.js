...
function updatePlanBadge(plan) {
    ...
    badge.className = `hidden md:inline-block text-[15px] px-2 py-0.5 rounded border font-mono font-bold ${isPremium ? "text-#008000-400 border-#008000-500/20 bg-#008000-500/10" : "text-#008000-400 border-#008000-500/20 bg-#008000-500/10 animate-pulse"}`;
